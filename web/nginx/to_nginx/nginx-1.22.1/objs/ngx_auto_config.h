#define NGX_CONFIGURE " --without-http_rewrite_module --with-http_ssl_module --with-http_stub_status_module --with-http_v2_module --with-cc-opt='-O3 -flto'"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 10.3.1 20210422 (Red Hat 10.3.1-1) (GCC) "
#endif
